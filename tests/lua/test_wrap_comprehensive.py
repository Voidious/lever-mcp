...
class TestListsWrapBehavior:
    ...
    @staticmethod
    def _assert_wrapped_structure(result, operation, expected_type):
    ...
    def test_list_returning_operations_with_wrap_true(self):
        ...
        for operation, expression, expected_type in test_cases:
            ...
            self._assert_wrapped_structure(result, operation, expected_type)
...
class TestDictsWrapBehavior:
    ...
    @staticmethod
    def _assert_wrapped_result(result, operation, expected_type):
        assert isinstance(
            result, dict
    ...
    def test_dict_returning_operations_with_wrap_true(self):
        ...
        for operation, expression, expected_type in test_cases:
            result = evaluate_expression(expression, {})
            self._assert_wrapped_result(result, operation, expected_type)
