...
class TestListsWrapBehavior:
    ...
    @staticmethod
    def _assert_wrapped_test_cases(test_cases, evaluate_expression):
    ...
    def test_list_returning_operations_with_wrap_true(self):
        ...
        self._assert_wrapped_test_cases(test_cases, evaluate_expression)
...
class TestDictsWrapBehavior:
    ...
    @staticmethod
    def _assert_wrapped_result(test_cases, evaluate_expression):
        for operation, expression, expected_type in test_cases:
            result = evaluate_expression(expression, {})
            assert isinstance(
                result, dict
    ...
    def test_dict_returning_operations_with_wrap_true(self):
        ...
        TestDictsWrapBehavior._assert_wrapped_result(test_cases, evaluate_expression)
