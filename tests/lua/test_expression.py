...
def assert_list_result_count(error, result, expected_count):
    assert error is None
    assert result is not None
...
async def test_remove_by_expression(client, items, expression, expected_count):
    ...
    assert_list_result_count(error, result, expected_count)
...
async def assert_list_operation(client, items, operation, expression, expected):
    result, error = await make_tool_call(
        client,
        "lists",
...
async def test_min_max_by_expression(
    ...
    await assert_list_operation(client, items, operation, expression, expected_value)
...
async def assert_any_eval_expression(client, value, expression, expected_result):
    result, error = await make_tool_call(
...
async def test_any_eval_expression(client, value, expression, expected_result):
    await assert_any_eval_expression(client, value, expression, expected_result)
...
async def test_new_list_by_operations_expressions(
    ...
    await assert_list_operation(client, items, operation, expression, expected_result)
