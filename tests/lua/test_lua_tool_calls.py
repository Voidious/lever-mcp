...
def run_comprehensive_tests():
    ...
    from tests.lua.lua_tool_calls.test_error_handling import (
        TestLuaEdgeCases,
        TestLuaErrorHandling,
    )
    from tests.lua.lua_tool_calls.test_function_refs import (
        TestLuaToolFunctionReferences,
        TestLuaWrapperFunctions,
    )
    from tests.lua.lua_tool_calls.test_operations import (
