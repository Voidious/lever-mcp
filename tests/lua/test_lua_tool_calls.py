...
def run_comprehensive_tests():
    ...
    from tests.lua.lua_tool_calls.test_dicts_any_generate import (
        TestLuaAnyOperations,
        TestLuaDictsOperations,
        TestLuaGenerateOperations,
    )
    from tests.lua.lua_tool_calls.test_edge_cases_errors import (
        TestLuaEdgeCases,
        TestLuaErrorHandling,
        TestLuaFunctionReturns,
    )
    from tests.lua.lua_tool_calls.test_generate_wrap import TestGenerateWrapParameter
    ...
    from tests.lua.lua_tool_calls.test_wrapper_functions import (
