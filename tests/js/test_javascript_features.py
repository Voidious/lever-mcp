...
async def _assert_eval_result(client, expression, expected_result):
...
async def test_arrow_functions(client, expression, expected_result):
    ...
    await _assert_eval_result(client, expression, expected_result)


# --- Template Literal Tests ---


async def assert_eval_result(client, context_value, expression, expected_result):
    result, error = await make_tool_call(
        client,
        "any",
...
async def test_template_literals(client, expression, context_value, expected_result):
    ...
    await assert_eval_result(client, context_value, expression, expected_result)
...
async def test_truthy_falsy_behavior(client, value, expression, expected_result):
    ...
    await assert_eval_result(client, value, expression, expected_result)
